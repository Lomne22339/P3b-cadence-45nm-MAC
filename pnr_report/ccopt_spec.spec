...
#  Generated on:      Wed Sep 16 19:50:14 2026
#  Design:            simple_mac
#  Command:           create_ccopt_clock_tree_spec -file ../pnr_report/ccopt_spec.spec -views {view1 view1}
###############################################################
#-------------------------------------------------------------------------------
...
#   clk (period 5.000ns) in timing_config sdc1([../syn_report/simple_mac_pd.sdc])
...
# Skew group to balance non generated clock:clk in timing_config:sdc1 (sdc ../syn_report/simple_mac_pd.sdc)
